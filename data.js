    ...
    "courses": [
        {
            ...
            "sessions": [
                { "type": "Section", "day": "Tuesday", "start": "10:00", "end": "11:00", "location": "القاعة الجديدة", "groups": ["IS Group 2"], "instructor": "م/ نادر جمال", "departments": ["IS"], "notes": "OR ومرة Programming احتمال مرة" },
                ...
                { "type": "Section", "day": "Thursday", "start": "09:30", "end": "10:30", "location": "قاعة (1)", "groups": ["IS Group 1"], "instructor": "م/ عبدالله حلمي", "departments": ["IS"], "notes": "احتمال الميعاد يتغير" },
        ...
        },
        {
            ...
            "departments": ["AI", "CS", "IS"],
            "sessions": [
                { "type": "Lecture", "day": "Saturday", "start": "09:00", "end": "10:00", "location": "البلازا الخارجية", "groups": ["CS Group 1", "CS Group 2", "IS Group 1", "IS Group 2"], "instructor": "د/ احمد جمال", "departments": ["CS", "IS"], "notes": "احتمال الميعاد يتغير" },
        ...
        },
        {
            ...
            "sessions": [
                ...
                { "type": "Section", "day": "Monday", "start": "11:00", "end": "12:00", "location": "البلازا الخارجية", "groups": ["CS Group 1"], "instructor": "م/ ابراهيم عبدالله", "departments": ["CS"], "notes": "الميعاد غير مؤكد" },
        ...
        },
        {
            ...
            "sessions": [
                ...
                { "type": "Section", "day": "Monday", "start": "11:00", "end": "12:00", "location": "البلازا الخارجية", "groups": ["IS Group 2"], "instructor": "م.م/ عبدالله حلمي", "departments": ["IS"], "notes": "الميعاد غير مؤكد" },
                { "type": "Section", "day": "Monday", "start": "12:00", "end": "13:00", "location": "البلازا الخارجية", "groups": ["CS Group 1"], "instructor": "م.م/ عبدالله حلمي", "departments": ["CS"], "notes": "الميعاد غير مؤكد" },
        ...
        },
        {
            ...
            "sessions": [
                ...
                { "type": "Section", "day": "Tuesday", "start": "10:00", "end": "11:00", "location": "البلازا الخارجية", "groups": ["IS Group 2"], "instructor": "م/ نادر جمال", "departments": ["IS"], "notes": "OR ومرة Programming احتمال مرة" },
        ...
        },
        {
            ...
            "sessions": [
                ...
                { "type": "Section", "day": "Wednesday", "start": "12:30", "end": "13:30", "location": "البلازا الخارجية", "groups": ["IS Group 1", "IS Group 2"], "instructor": "م/ ابتهال يسري", "departments": ["CS", "IS"], "notes": "احتمال الميعاد يتغير" },
            ]
        }
    ]
};
