    ...
    "courses": [
        {
            ...
            "sessions": [
                { "type": "Section", "day": "Wednesday", "start": "11:30", "end": "12:30", "location": "البلازا الخارجية", "groups": ["CS Group 1, CS Group 2"], "instructor": "م/ سارة سمير", "departments": ["CS"], "notes": "" },
                ...
                { "type": "Section", "day": "Thursday", "start": "09:30", "end": "10:30", "location": "القاعة الجديدة", "groups": ["IS Group 2"], "instructor": "م/ سارة سمير", "departments": ["IS"], "notes": "" },
                { "type": "Lecture", "day": "Thursday", "start": "11:00", "end": "12:00", "location": "البلازا الداخلية", "groups": ["CS Group 1", "CS Group 2", "IS Group 1", "IS Group 2"], "instructor": "ا.م.د/ سارة شهاب", "departments": ["CS", "IS"], "notes": "" },
        ...
        },
        {
            ...
            "sessions": [
                ...
                { "type": "Section", "day": "Monday", "start": "09:00", "end": "10:00", "location": "البلازا الخارجية", "groups": ["CS Group 1"], "instructor": "م.م/ احمد عبدالسلام, م/ مريم فياض", "departments": ["CS"], "notes": "" },
        ...
        },
        {
            ...
            "departments": ["AI", "CS", "IS"],
            "sessions": [
                { "type": "Section", "day": "Monday", "start": "11:00", "end": "12:00", "location": "القاعة الجديدة", "groups": ["CS Group 2"], "instructor": "م.م/ هبه فتحي", "departments": ["CS"], "notes": "" },
                { "type": "Section", "day": "Monday", "start": "13:00", "end": "14:00", "location": "البلازا الخارجية", "groups": ["CS Group 1"], "instructor": "م/ ابراهيم عبدالله", "departments": ["CS"], "notes": "" },
                ...
                { "type": "Section", "day": "Wednesday", "start": "11:00", "end": "12:00", "location": "البلازا الخارجية", "groups": ["IS Group 1"], "instructor": "م.م/ هبه فتحي", "departments": ["IS"], "notes": "" },
                { "type": "Section", "day": "Wednesday", "start": "11:00", "end": "12:00", "location": "القاعة الجديدة", "groups": ["IS Group 2"], "instructor": "م. ابراهيم عبدالله", "departments": ["IS"], "notes": "" },
        ...
        },
        {
            ...
            "sessions": [
                ...
                { "type": "Section", "day": "Monday", "start": "11:00", "end": "12:00", "location": "البلازا الخارجية", "groups": ["IS Group 1"], "instructor": "م.م/ هبه فتحي", "departments": ["IS"], "notes": "" },
                ...
                { "type": "Section", "day": "Wednesday", "start": "09:00", "end": "10:00", "location": "البلازا الداخلية", "groups": ["CS Group 2"], "instructor": "م.م/ هبه فتحي", "departments": ["CS"], "notes": "" },
        ...
        },
        {
            ...
            "sessions": [
                ...
                { "type": "Section", "day": "Tuesday", "start": "10:00", "end": "11:00", "location": "البلازا الخارجية", "groups": ["IS Group 2"], "instructor": "م/ نادر جمال", "departments": ["IS"], "notes": "" },
                ...
                { "type": "Section", "day": "Tuesday", "start": "12:00", "end": "13:00", "location": "القاعة الجديدة", "groups": ["CS Group 1"], "instructor": "م/ ديفيد كمال", "departments": ["CS"], "notes": "" },
                { "type": "Section", "day": "Wednesday", "start": "09:00", "end": "10:00", "location": "القاعة الجديدة", "groups": ["CS Group 2"], "instructor": "م.م/ سلمى رأفت", "departments": ["CS"], "notes": "" },
        ...
        },
        {
            ...
            "departments": ["CS", "IS"],
            "sessions": [
                { "type": "Lecture", "day": "Saturday", "start": "12:15", "end": "13:15", "location": "البلازا الخارجية", "groups": ["CS Group 1", "CS Group 2", "IS Group 1", "IS Group 2"], "instructor": "د/ كرم السيد", "departments": ["CS", "IS"], "notes": "" },
                { "type": "Section", "day": "Wednesday", "start": "12:30", "end": "13:30", "location": "القاعة الجديدة", "groups": ["CS Group 1", "CS Group 2"], "instructor": "م/ ياسمين سمير", "departments": ["CS"], "notes": "" },
                { "type": "Section", "day": "Wednesday", "start": "11:00", "end": "12:00", "location": "البلازا الخارجية", "groups": ["IS Group 1"], "instructor": "م/ ابتهال يسري", "departments": ["IS"], "notes": "" },
                { "type": "Section", "day": "Thursday", "start": "09:00", "end": "10:00", "location": "القاعة الجديدة", "groups": ["IS Group 2"], "instructor": "م/ ياسمين سمير", "departments": ["IS"], "notes": "" },
            ]
        }
    ]
};
